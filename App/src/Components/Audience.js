...
import { faHeadphones, faStore, faUser, faGift, faHome } from '@fortawesome/free-solid-svg-icons'
        ...
        return (
            <div style = {styles.main}>
                ...
                <div>
                  <form>
                    <div style = {styles.form}>
                      <h3 style = {{textAlign:"center"}}> <FontAwesomeIcon icon={faHome}/>Home</h3>
                      <input type="submit"  onClick={this.onLogoutClick} style = {styles.button} value="Logout" />
                    </div>
                  </form>
                </div>
            </div>
...
//<input type="submit"  onClick={this.logoutUser} style = {styles.button} value="Logout" />
